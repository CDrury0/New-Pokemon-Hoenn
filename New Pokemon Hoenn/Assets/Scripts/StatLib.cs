...
public static class StatLib
{
    ...
    public static string ExtractName(string workingString)
    {
        string newName = "";
        for (int i = 0; i < workingString.Length; i++)
        {
            newName += workingString[i] == '_' ? ' ' : workingString[i];
        }
        return newName;
    }
    ...
    /*private static float GetSingleTypeMatchup(Type moveType, Type monType)
    {
        switch (moveType)
        {
            case Type.Normal:
    ...
    public static float GetTypeMatchup(Type moveType, Pokemon target)
    {
        float typeX1 = GetSingleTypeMatchup(moveType, target.type1);
        float typeX2 = GetSingleTypeMatchup(moveType, target.type2);
        return (typeX1 == WEAKNESS && typeX2 == RESIST) || (typeX1 == RESIST && typeX2 == WEAKNESS) ? 1 : typeX1 * typeX2;
    }*/
}
